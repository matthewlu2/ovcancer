...
def contact_page():    
    ...
    a.markdown("""<span style="font-size:18px;">Linan Zhang<br>Research Scientist<br>✉️ liz133@pitt.edu</span>""", unsafe_allow_html=True)

    a.markdown("""<span style="font-size:18px;">Matthew Lu<br>Computer Science Intern<br>✉️ mal554@pitt.edu</span>""", unsafe_allow_html=True)
